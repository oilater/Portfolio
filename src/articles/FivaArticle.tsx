    ...
    <div>
      ...
      <section css={section}>
        ...
        <p>
          ...
          유니티 특성상 오브젝트에 코드를 붙이다보니, <span css={highlightText}>클래스마다 역할을 나누어 객체지향적으로 UI를 구현했습니다.</span>
        </p>
      ...
      <section css={section}>
        ...
        <article>
          ...
          <p>
            ...
            그래도 첫 회사에서 정말 좋은 팀원 분들을 만나 즐거웠던 시간이었습니다. 마지막에 팀원들과 메시지를 주고 받았는데, 모든 분들에게 분위기 메이커라는 얘기를 들어서 좋았습니다.
