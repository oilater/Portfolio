...
const myData: MyData[] = [
  ...
  },
  {
    ...
    description: 'SLASH 23을 통해 토스 인터렉션 팀이 개발한 Rally를 보고 저만의 인터렉션 시스템을 만들어보고 싶었습니다. 여러 시행착오를 통해 Rally의 구조가 사용하기 쉽고 확장성이 좋다고 생각하였고, 구조를 예상하며 따라 만들어보았습니다. 이 포트폴리오도 Rally를 사용해 제작했습니다 😀',
  },
  {
    id: 3,
    title: '👨‍💻 토스에 가고 싶은 이유',
    description: '불필요한 비용은 줄이고, 개발에 집중하는 토스의 문화에서 함께 일하고 싶습니다. UI 개발이라면 재밌어서 밤도 거뜬히 샐 수 있는 저의 열정을 토스에서 발휘하고 싶습니다.',
  },
];
