...
const myData: MyData[] = [
  ...
  },
  {
    id: 2,
    title: '🧚🏻 인터렉션 시스템 개발',
    description: 'SLASH에서 토스 인터렉션 팀의 Rally를 접하고, 저만의 인터렉션 시스템을 만들어보고 싶었습니다. 확장성이 좋은 Rally의 구조를 참고하여 모든 React Element에 쉽게 적용할 수 있는 인터렉션 시스템을 구현해 포트폴리오에 적용해보았습니다.',
  },
  {
    id: 3,
    title: '👨🏼‍💻 빠른 적응력과 실행력',
