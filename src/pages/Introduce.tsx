...
const myData: MyData[] = [
  ...
  },
  {
    ...
    description: '좋은 코드를 만드는 엔지니어가 되고 싶습니다. 저는 새로운 기술과 업무 환경에 빠르게 적응하는 학습 능력과 실행력을 가지고 있습니다. 함께 일하게 된다면 토스의 빠른 성장 환경에서 빠르게 업무를 익히고, 사용자에게 가치 있는 서비스를 만들기 위해 최선을 다하겠습니다.',
  },
];
